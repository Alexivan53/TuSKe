...
public class TuSKe extends JavaPlugin {
	...
	public void onEnable() {
		...
		updater = new GitHubUpdater(this, getFile(), "Alexivan53/TuSKe", getConfig().getBoolean("updater.download_pre_releases"));
		// ----------------------------------------------------------
		// ------------------------ Listener ------------------------
		...
		// Announce version and repo
		log("Version v" + getDescription().getVersion() + " - Repository: https://github.com/Alexivan53/TuSKe");
