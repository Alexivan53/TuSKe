...
public class EffCancelDrop extends Effect{
	...
	public boolean init(Expression<?>[] arg0, int arg1, Kleenean arg2, ParseResult arg3) {
		if ((canCancelBreakDrops && !SkriptCompat.isCurrentEvent(PlayerDeathEvent.class, BlockBreakEvent.class) ||
				(!canCancelBreakDrops && !SkriptCompat.isCurrentEvent(PlayerDeathEvent.class)))){
